...
export default function BookmarksPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Bookmarked Employees</h1>
        ...
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {bookmarks.map(u => (
            <Card key={u.id} className="transition-all duration-300 hover:shadow-lg">
              ...
              <div className="mt-4">
                <p className="text-sm font-medium text-gray-900">Department: <span className="font-normal">{u.department}</span></p>
                <p className="text-sm font-medium text-gray-900 mt-1">Performance:</p>
                <div className="mt-1">
