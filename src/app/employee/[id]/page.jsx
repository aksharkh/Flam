...
export default function EmployeePage() {
  ...
  if (!user) return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
      ...
      <h3 className="mt-4 text-2xl font-medium text-gray-900 text-gray-900">Employee not found</h3>
      <p className="mt-2 text-gray-900">The requested employee could not be found</p>
    </div>
  )
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        {/* Profile Header */}
        <div className="bg-gradient-to-r from-slate-300 to-indigo-800 p-6 md:p-8">
            ...
            <div className="mt-4 md:mt-0 md:ml-8 text-center md:text-left">
              ...
              <div className="mt-2 flex flex-wrap justify-center md:justify-start">
                <div className="flex items-center mx-2 my-1">
                  ...
                  <span className="ml-1 text-black">{user.email}</span>
                </div>
                <div className="flex items-center mx-2 my-1">
        ...
        <div className="border-b border-gray-200">
          <div className="flex overflow-x-auto">
            {['Overview', 'Projects', 'Documents', 'Activity', 'Feedback'].map(t => (
              <button
                key={t}
                onClick={() => setTab(t)}
                className={`px-5 py-4 font-medium text-gray-900 text-sm relative ${
                  tab === t 
        ...
        <div className="p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">Jan 15, 1990</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <p className="text-sm text-gray-900">Hire Date</p>
                      <p className="font-medium text-gray-900">Jun 12, 2018</p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-900">Reports to: Sarah Johnson</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  {history.map((h, index) => (
                    <div key={h.year} className={`flex items-center py-3 ${index !== history.length - 1 ? 'border-b border-gray-100' : ''}`}>
                      <div className="w-16">
                        <span className="text-gray-900">{h.year}</span>
                      </div>
                      ...
                      <div className="text-right">
                        <span className="font-medium text-gray-900">{h.rating.toFixed(1)}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                {[1, 2, 3].map(project => (
                  <div key={project} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex justify-between">
                      <h3 className="font-medium text-gray-900">Project Apollo v{project}.0</h3>
                      <Badge color={project === 1 ? 'green' : project === 2 ? 'blue' : 'yellow'}>
                        {project === 1 ? 'On Track' : project === 2 ? 'In Review' : 'Planning'}
                      </Badge>
                    </div>
                    <p className="text-sm text-gray-900 mt-1">Next generation customer portal development</p>
                    ...
                    <div className="mt-4 flex justify-between items-center">
                        ...
                        <div className="w-48 h-2 bg-gray-200 rounded-full mt-1">
                          <div 
                            className={`h-full rounded-full ${
                              project === 1 ? 'bg-green-900 w-3/4' : 
                              project === 2 ? 'bg-blue-900 w-1/2' : 
                              'bg-yellow-900 w-1/4'
                            }`}
                          ></div>
                        </div>
                      ...
                      <div className="text-right">
                        <p className="text-xs text-gray-900">Team</p>
            ...
            <div>
              ...
              <div className="bg-gray-100 rounded-lg p-5">
                ...
                <textarea 
                  ...
                  className=" text-gray-900 mt-2 w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:border-transparent"
                  rows="4"
                ></textarea>
              ...
              <h3 className="font-medium text-gray-900 text-gray-900 mt-6 mb-4">Recent Feedback</h3>
              <div className="space-y-4">
                {[1, 2].map(review => (
                  <div key={review} className="border border-gray-200 bg-gray-100 rounded-lg p-4">
                    <div className="flex justify-between">
                      <div className="flex items-center">
          ...
          {(tab === 'Documents' || tab === 'Activity') && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900 text-gray-900">Coming Soon</h3>
              <p className="mt-2 text-gray-900">{tab} section is under development</p>
            </div>
          )}
        </div>
      </div>
